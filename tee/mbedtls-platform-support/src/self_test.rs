...
// needs to be pub for global visiblity
#[cfg(all(
    any(not(feature = "std"), target_env = "sgx"),
    not(target_env = "msvc")
))]
#[doc(hidden)]
#[no_mangle]
...
/// information.
pub use mbedtls_sys::{
    aes_self_test as aes, arc4_self_test as arc4, aria_self_test as aria,
    base64_self_test as base64, camellia_self_test as camellia, ccm_self_test as ccm,
