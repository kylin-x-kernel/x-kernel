...
const DEFAULT_DEFINES: &'static [CDefine] = &[
    ...
    ("MBEDTLS_SM2_ALT",                                   Undefined),
    ("MBEDTLS_SM3_ALT",                                   Undefined),
    ("MBEDTLS_SM4_ALT",                                   Undefined),
    ...
    ("MBEDTLS_SM2_PROCESS_ALT",                           Undefined),
    ("MBEDTLS_SM3_PROCESS_ALT",                           Undefined),
    ("MBEDTLS_SM4_PROCESS_ALT",                           Undefined),
    ...
    ("MBEDTLS_ECP_DP_SM2P256R1_ENABLED",                  Defined),
    ...
    ("MBEDTLS_KEY_EXCHANGE_SM2_ENABLED",                  Defined),
    ...
    ("MBEDTLS_SM2_C",                                     Defined),
    ("MBEDTLS_SM3_C",                                     Defined),
    ("MBEDTLS_SM4_C",                                     Defined),
