...
static const oid_pk_alg_t oid_pk_alg[] =
{
    ...
    {
        { ADD_LEN( MBEDTLS_OID_EC_SM2P256R1 ),  "id-sm2",    "SM2" },
        MBEDTLS_PK_SM2,
    },
    {
        { NULL, 0, NULL, NULL },
...
/*
oid_pk_alg_fix 用于从公钥算法类型获取 OID
当为国密算法 SM2 时，兼容 EC , 此时算法类型需要配置为 OID MBEDTLS_OID_EC_ALG_UNRESTRICTED
SM2 公钥示例：
  0  89: SEQUENCE {
  2  19:   SEQUENCE {
 ...
 13   8:     OBJECT IDENTIFIER '1 2 156 10197 1 301'
       :     }
 23  66:   BIT STRING
       :     04 EE F6 DE CF 25 C3 CF 9C AF 9C C8 0D BD 75 9D
       :     F6 B9 40 00 23 42 30 AA 90 BC F4 BD 02 5C 8D 68
       :     FD 21 15 E7 A3 52 68 0B 8E B8 5E 08 B6 9C F9 02
       :     35 74 D0 DC E1 95 D2 C5 B8 77 F2 E8 4E C6 26 A9
       :     B8
       :   }
*/
static const oid_pk_alg_t oid_pk_alg_fix[] =
{
    {
        { ADD_LEN(MBEDTLS_OID_PKCS1_RSA),      "rsaEncryption",   "RSA" },
        MBEDTLS_PK_RSA,
