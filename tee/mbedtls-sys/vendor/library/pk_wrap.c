                       ...
                       const unsigned char *sig, size_t sig_len )
{
    ...
    return mbedtls_sm2_verify_asn1((mbedtls_sm2_context *) ctx, md_alg, hash, hash_len, sig, sig_len);
}
                   ...
                   int (*f_rng)(void *, unsigned char *, size_t), void *p_rng )
{
    ...
    ret = mbedtls_sm2_sign_asn1((mbedtls_sm2_context *)ctx, md_alg, hash, sig, sig_len, f_rng, p_rng);
    return( ret );
}
                    ...
                    int (*f_rng)(void *, unsigned char *, size_t), void *p_rng )
{
    ...
    if( ilen < addlen || osize < (ilen - addlen) )
        return( MBEDTLS_ERR_RSA_BAD_INPUT_DATA );
    return mbedtls_sm2_decrypt_asn1( (mbedtls_sm2_context *) ctx, md_type,
                    ...
                    int (*f_rng)(void *, unsigned char *, size_t), void *p_rng )
{
    ...
    if( osize < (ilen + addlen) )
        return( MBEDTLS_ERR_RSA_BAD_INPUT_DATA );
    return mbedtls_sm2_encrypt_asn1( (mbedtls_sm2_context *) ctx, md_type,
