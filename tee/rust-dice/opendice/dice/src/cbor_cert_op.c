...
DiceResult DiceGenerateCertificate(
  ...
  *certificate_actual_size = 0;
  ...
  // DMSG("subject_id_hex");
  // DHEXDUMP(subject_id_hex, sizeof(subject_id_hex));
  ...
  // DMSG("authority_id_hex");
  // DHEXDUMP(authority_id_hex, sizeof(authority_id_hex));
  ...
  // DMSG("encoded_public_key");
  // DHEXDUMP(encoded_public_key, encoded_public_key_size);
  ...
  // DMSG("protected_attributes");
  // DHEXDUMP(protected_attributes, protected_attributes_size);
  ...
  // DMSG("cwt_ptr");
  // DHEXDUMP(cwt_ptr, final_cwt_size);
