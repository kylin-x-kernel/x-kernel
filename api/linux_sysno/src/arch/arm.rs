...
// This file contains Linux system call numbers for arm architecture.
// These definitions are derived from the Linux kernel UAPI headers
// (arch/arm/include/asm/unistd.h), which are licensed under
