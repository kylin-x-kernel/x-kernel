...
// This file contains Linux system call numbers for x86_64 architecture.
// These definitions are derived from the Linux kernel UAPI headers
// (arch/x86/include/asm/unistd.h), which are licensed under
