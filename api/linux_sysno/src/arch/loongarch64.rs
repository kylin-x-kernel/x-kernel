...
// This file contains Linux system call numbers for loongarch64 architecture.
// These definitions are derived from the Linux kernel UAPI headers
// (arch/loongarch/include/asm/unistd.h), which are licensed under
// GPL-2.0 WITH Linux-syscall-note (SPDX: GPL-2.0-only WITH Linux-syscall-note).
// The syscall-note exception explicitly permits user-space programs to use
// these definitions without being subject to GPL.
//
