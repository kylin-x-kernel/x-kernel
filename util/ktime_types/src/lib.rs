...
//! Unix timestamp. [`TimestampLimits`] describes the precision and inclusive
//! range a persistent format can represent. The distinct types prevent
//! durations, deadlines, and wall clock timestamps from being mixed
//! accidentally.
