...
- `<name>`, like `cargo platconfig add platconfig-x86-pc` (latest version will be used)
- `<name>@<version-req>`, like `cargo platconfig add platconfig-x86-pc@0.1` or `cargo platconfig add platconfig-x86-pc@=0.1.2`")]
    dep_id: Vec<String>,
